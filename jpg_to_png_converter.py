...
if __name__ == '__main__':
    ...
    if (len(source_folder.strip()) == 0):
        ...
        source_folder = addSlashIfMissing(source_folder)
        destination_folder = addSlashIfMissing(destination_folder)
        convert_all_jpeg_images_to_png_format(source_folder, destination_folder)
